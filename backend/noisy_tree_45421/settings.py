"""
Django settings for noisy_tree_45421 project.
...
ROOT_URLCONF = 'noisy_tree_45421.urls'
...
WSGI_APPLICATION = 'noisy_tree_45421.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_tree_45421 API",
    "DESCRIPTION": "API documentation for noisy_tree_45421 App",
    "VERSION": "v1",
}
